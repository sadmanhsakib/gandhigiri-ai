...
def main():
    samples = [
        "The path you are walking on, son, will one day get you in trouble.",
        "Beta, sach bolo aur sir uthake jio. Tumne bachan diya tha, mera ek kaam karoge.",
    ]
...
def text_to_speech(
    text: str, output_path: str = "audio_output/output.wav"
) -> str:
    """
